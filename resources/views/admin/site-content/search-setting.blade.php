...
<div class="py-4">
    ...
    <form action="{{ route('admin.search-setting.update', $siteContent) }}" method="post" id="frmProductDetail" enctype="multipart/form-data">
        @csrf
        @method('PUT')
                ...
                <div class="card">
                    ...
                    <div class="card-body py-2">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    <input type="text" class="form-control" id="side-content-excerpt" name="content"
                            ...
                            <div class="col">
                                <div class="form-group">
                                    <input type="file" class="form-control" id="site-content-image" name="image"
                                        onchange="readURL('#preview-image',this, null, 336)">
                                    <div class="row mt-4">
