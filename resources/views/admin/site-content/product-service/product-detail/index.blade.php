...
<div class="py-4">
    ...
    <form action="{{ route('admin.product-detail.update', $siteContent) }}" method="post" id="frmProductDetail" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        @if ($contentImage)
            <div class="row mb-3">
                <div class="col">
                    <div class="card">
                        <div class="card-header pb-0">
                            <label class="mb-0 ms-0" for="content-image">
                                <h6 class="mb-0">Content Image</h6>
                            </label>
                        </div>
                        <div class="card-body">
                            <div class="form-group">
                                <label class="mb-0" for="content-image">
                                    <h6 class="mb-0">Image</h6>
                                </label>
                                <input type="file" class="form-control" id="content-image" name="content-image"
                                    onchange="readURL('#preview-image2',this, null, 500)">
                                <div class="row mt-4">
                                    <img id="preview-image2" src="{{ url($contentImage->image ?? '') }}"
                                        alt="{{ $contentSide->title }}" style="object-fit: contain" height="500"/>
                                </div>
                            </div>
                        </div>
                    </div>
