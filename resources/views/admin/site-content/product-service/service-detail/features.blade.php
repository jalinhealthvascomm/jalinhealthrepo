    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title font-weight-normal" id="exampleModalLabel">New Client Services</h5>
...
<div class="modal fade" id="modalFeatureEdit" tabindex="-1" role="dialog" aria-labelledby="modalFeatureEdit"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title font-weight-normal">Edit Client Services</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="" method="post" id="frmServiceFeatureEdit"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col">
        ...
        <div class="col">
            <div class="navbar navbar-expand-lg navbar-light bg-white z-index-3 py-3">
                <div class="ps-0 d-flex justify-content-between" style="width: 100%;">
                    <a href="{{ route('admin.service-detail.index') }}"><i class="fas fa-arrow-left text-sm ms-1"
                            aria-hidden="true"></i></a>
                    <h5 class="mb-0">Benefits Client Services</h5>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="card mb-4">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between align-items-center">
                        <h5>Benefits Client Services</h5>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        ...
                                        <a href="#" class="text-secondary font-weight-bold text-xs act-btn me-3"
                                            ...
                                            onclick="itemDelete('{{ $contentFeature->features }}', '/admin/content-feature/delete/{{$contentFeature->id}}')">
                                            Delete
                                        </a>
                                        @endif
                                        <a href="#" class="text-secondary font-weight-bold text-xs"
                                            ...
                                            onclick="serviceFeatureEdit({{$contentFeature}})">
                                            Edit
                                        </a>
                                    </td>
                                </tr>
