                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" value="{{$category->id}}" name="category" id="categories-{{$category->id}}" @if ( $category->id == 1 ) @checked(true) @endif>
